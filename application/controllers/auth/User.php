<?php
    ...
    class User extends CI_Controller 
    {
            ...
            if(!empty($this->input->post()))
            {
                ...
                else
                {
                    ...
                    if(!empty($user_id))
                    {
                        ...
                        $this->session->set_flashdata('success','Activation link sent to your email. Please activate.');
        ...
        public function user_create_activation_sendmail($input_data)
        {
            ...
            $headers = "From: Akhil (info@ninjaswork.com)";
        ...
        */
        ...
        {       
            ...
            $headers = "From: ImageHosting.NinjasWork.com (info@ninjaswork.com)";
            $mail_config = array('to' => $email_data['email'],
                                'subject' => 'ImageHosting.NinjasWork Password Request',
                                'message' => $message_details,
                                'headers'=>$headers
                            );
            send_email($mail_config);
